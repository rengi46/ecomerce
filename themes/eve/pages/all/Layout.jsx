        ...
        <div className="page-width grid grid-cols-1 md:grid-cols-3 gap-2 justify-between">
          ...
          <div>
            <h3>Aviso Legal</h3>
                ...
                <li className="nav-item">
                    <a className="nav-link hover:underline" href={"/page/terminos-y-condiciones"}>
                    Términos y Condiciones
                    </a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link hover:underline" href={"/page/politica-de-privacidad"}>
                      Politicas de privacidad
                    </a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link hover:underline" href={"/page/politica-de-cookies"}>
          ...
          <div className="self-center">
            <div className="copyright text-center md:text-right text-textSubdued">
              <span>Copyright © 2020 CBDTera</span>
            </div>
          </div>
        </div>
      </div>
