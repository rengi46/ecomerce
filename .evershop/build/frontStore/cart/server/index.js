  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    onSuccess: async response => {
      if (!response.error) {
        ...
        url.searchParams.set('ajax', true);
        await AppContextDispatch.fetchPageData(url);
        react_toastify_esm/* toast */.Am.success('Coupon applied successfully!');
      } else {
        react_toastify_esm/* toast */.Am.error('Invalid coupon');
      }
    },
    onError: () => {
      react_toastify_esm/* toast */.Am.error('Something wrong. Please reload the page!');
    },
    id: "couponForm"
...
_evershop_evershop_src_components_common_Area__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z.defaultProps.components = {
  ...
  content: {
    'XG5vZGVfbW9kdWxlc1xAZXZlcnNob3BcZXZlcnNob3Bcc3JjXG1vZHVsZXNcY2hlY2tvdXRccGFnZXNcZnJvbnRTdG9yZVxjYXJ0XFNob3BwaW5nQ2FydC5qc3g=': {
      ...
      sortOrder: 1,
      component: __webpack_require__(5566)
    },
  ...
  shoppingCartRight: {
    XG5vZGVfbW9kdWxlc1xAZXZlcnNob3BcZXZlcnNob3Bcc3JjXG1vZHVsZXNcY2hlY2tvdXRccGFnZXNcZnJvbnRTdG9yZVxjYXJ0XFN1bW1hcnkuanN4: {
      ...
      sortOrder: 10,
      component: __webpack_require__(46305)
    }
  },
  footer: {
  ...
  shoppingCartLeft: {
    XG5vZGVfbW9kdWxlc1xAZXZlcnNob3BcZXZlcnNob3Bcc3JjXG1vZHVsZXNccHJvbW90aW9uXHBhZ2VzXGZyb250U3RvcmVcY2FydFxDb3Vwb24uanN4: {
      ...
      sortOrder: 20,
      component: __webpack_require__(8004)
    }
  }
};
})();
